...
void HFAMapRunBoundedScan(void (^completion)(NSDictionary *summary)){
 ...
 if(!selected){analysis=@{@"schema":@"com.hfa.zpatchig.analysis/v2",@"version":@"0.2.1",@"status":@"incomplete",@"session":session,@"appIdentity":appIdentity,@"reason":reason?:@"selection-failed",@"candidates":candidates,@"observations":@[],@"validatedFeatures":@[]};}
 else{NSDictionary*resolved=ZPResolveCandidate(selected,started+4.5,events);NSDictionary*descriptor=resolved[@"descriptor"]?:@{};NSDictionary*observer=descriptor.count?ZPDescriptorObserverArm(selected,descriptor,10.0):@{@"status":@"not-armed",@"reason":@"descriptor-missing"};[events addObject:@{@"time":@(NSDate.date.timeIntervalSince1970),@"stage":@"descriptor-observer",@"status":observer[@"status"]?:@"?",@"details":observer}];analysis=@{@"schema":@"com.hfa.zpatchig.analysis/v2",@"version":@"0.2.1",@"status":resolved[@"status"]?:@"analysis-only",@"session":session,@"appIdentity":appIdentity,@"candidate":selected,@"family":resolved[@"family"]?:@"unknown",@"descriptor":descriptor,@"descriptorObserver":observer,@"observations":resolved[@"observations"]?:@[],@"validatedFeatures":resolved[@"validatedFeatures"]?:@[],@"canonicalEligible":resolved[@"canonicalEligible"]?:@NO,@"canonicalReason":resolved[@"canonicalReason"]?:@"unknown"};}
