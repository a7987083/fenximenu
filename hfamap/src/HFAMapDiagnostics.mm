...
static NSString *HFAJSONString(id value){if(!value||![NSJSONSerialization isValidJSONObject:value])return @"{}";NSData*d=[NSJSONSerialization dataWithJSONObject:value options:0 error:nil];return d?[[NSString alloc]initWithData:data encoding:NSUTF8StringEncoding]:@"{}";}
