...
void HFADiagnosticsLog(NSString *stage, NSString *status, NSDictionary *details) {
    ...
    HFAAppend([documents stringByAppendingPathComponent:@"ZPatchIG_Diagnostics.jsonl"],
              [json dataUsingEncoding:NSUTF8StringEncoding]);
    HFAAppend([documents stringByAppendingPathComponent:@"ZPatchIG_Diagnostics.log"],
