...
## 2026-09-22 v2.3.9-dev IL2CPP Runtime Resolver（已编译，待实机）
...
- 69/69 tests 通过。当前 HEAD `cbc0351b9d12ba6762dbd3b340e4ff90688614a4`；Actions Run `35722643492` 成功；artifact `10691817650`。
- arm64 dylib：266272 bytes；UUID `6AF0A6F6-CD75-3D59-8A42-28DC806996F6`；SHA256 `561e979e0181724dc5f54d43160ae8e698d956ab0016a76839a7c1c9090b3e2d`；Dobby 静态内置且无外部 Dobby dylib 依赖。
- 当前严格状态：已修改、已提交、已 CI 编译、未运行、未实机。
