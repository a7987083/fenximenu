...
+ (NSDictionary<NSString *,id> *)metadata { return @{@"generator_version":@"2.2.0",@"dylib_id":@(5),@"dylib_key":@"zonoe.main",@"version_id":@(2),@"version_state":@"testing",@"runtime_config_version":@(3),@"api_base_url":@"https://app3.zonoeios.xyz"}; }
@end
